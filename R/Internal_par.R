...
#'
#' @seealso \code{\link{lvhml_est}} for the description of \code{Y}, \code{R}, \code{X}, \code{par}, \code{n.cores} and \code{Silent}.
#' @keywords internal
#'
...
lvhml_est_fit_K <- function(Y, Ymatlog, R, XZ, X, XZmat, indices_R, lengths_R, Tp, K, cov_len, px, N, J, Tinit, Uinit, par, n.cores, Silent) {
  # Initialization
  ...
  hats <- lvhml_norm(J, N, cov_len, px, t(GetAfromU.func(Uit[, , final_iter], Tp, cov_len, K)), Thetait[, , final_iter], GetGammafromU.func(Uit[, , final_iter], Tp), tBeta, X)
